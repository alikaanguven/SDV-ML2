...
# JSON_PATH='/groups/hephy/cms/alikaan.gueven/ParT/runs/vtx_PART-859/jsons/CustomNanoAOD_GNNAVRIVF_new2.json'
JSON_PATH='/groups/hephy/cms/alikaan.gueven/ParT/runs/vtx_PART-859/jsons/CustomNanoAOD_GNN_data_merged.json'
...
MODEL_PATH     = '/groups/hephy/cms/alikaan.gueven/ParT/models/vtx_PART-859_epoch_87.pt'
...
# INPUT_BASEDIR  = '/scratch-cbe/users/alikaan.gueven/ML_KAAN/CustomNanoAOD_GNNAVRIVF_new2_merged'
INPUT_BASEDIR  = '/scratch-cbe/users/alikaan.gueven/ML_KAAN/Ang_GNN_nano_data_merged'
job_dict = {}
...
for sample in samples:
    ...
    if IS_DATA:
        command = f'python3 -u {PREDICT_SCRIPT} {INPUT_DIR} {MODEL_PATH} --isData'
    else:
