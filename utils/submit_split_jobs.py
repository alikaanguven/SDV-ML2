...
json_file = "/scratch/agueven/ParT/runs/vtx_PART-1065_IVF/jsons/hepgpu_IVF_trainK.json"
...
OUTBASEDIR = '/scratch/agueven/20260112/IVF_train_split'
...
def run_job(pattern):
    ...
    # print('Path(pattern).parents[2].name: ', Path(pattern).parents[2].name)
    # print('Path(pattern).parents[1].name: ', Path(pattern).parents[1].name)
    # print('Path(pattern).parents[0].name: ', Path(pattern).parents[0].name)
