...
SRC_BASE     = "/scratch/agueven/20260112/IVF_train_split/"
DST_BASE     = "/scratch/agueven/20260112/IVF_train_shuffled/"
...
OUT_PREFIX   = "ivf_train_mix"   # prefix for output files: e.g. ALL__merged_000.root
CHUNK_GB     = 2.0
